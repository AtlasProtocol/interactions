...
(function () {
    ...
    SingleStageSmartdrop.prototype = new Super();
})();

//{"address1":true,"address2":true,"address3":true}
SingleStageSmartdrop.prototype.addAddress = function (address, signature) {
    this._checkAuthorization(signature);
...
SingleStageSmartdrop.prototype.isValidAddr = function (address) {
    return this.ValidAddressArrayMap.get(address) !== null
};

SingleStageSmartdrop.prototype._checkInteractPreCondition = function (address) {
    if (address !== undefined && !this.isValidAddr(address)) {
        throw new Error("Unauthorized address");
    }
};

SingleStageSmartdrop.prototype._checkGetTIEPreCondition = function (address) {
    if (address !== undefined && !this.isValidAddr(address)) {
        throw new Error("Unauthorized address");
    }
};

module.exports = SingleStageSmartdrop;
